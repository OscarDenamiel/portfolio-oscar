...
export const KNOWLEDGE_BASE = [
  ...
  {
    id: 'why-hire-me',
    triggers: ['por que contratarte', 'why should we hire you', 'per que contractar-te', 'que te hace diferente', 'what makes you different', 'que et fa diferent', 'convenceme', 'convince me', 'convence\'m', 'pitch', 'en 60 segundos', 'in 60 seconds', 'en 60 segons', 'elevator pitch', 'value proposition', 'propuesta de valor'],
    response: {
